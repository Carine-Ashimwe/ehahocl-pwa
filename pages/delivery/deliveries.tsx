            ...
            <Card className="shadow">
              <CardHeader className="border-0">
                <Row className="align-items-center">
                  <div className="col">
                    <h3 className="mb-0">Deliveries</h3>
                  </div>
                ...
                <tbody>
                  {
                    isLoading ? (
                      ...
                      : isError ? (
                        ...
                        : isSuccess && data.length > 0 && data[0].length > 0 ? (
                          ...
                          : (
                            <option>No deliveries found</option>
                          )
                  }
                </tbody>
              </Table>
