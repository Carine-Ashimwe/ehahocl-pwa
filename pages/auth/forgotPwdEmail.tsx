    ...
    const sendEmail = async () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                setTimeout(()=>{Router.push("/auth/forgotPwdVerification")}, 3000);
                }else{
            ...
            <div className="auth-form">
                <Card className="bg-secondary shadow border-0">
                    <CardHeader className="bg-transparent">
                        ...
                        <Link href="/auth/login" className="color-primary" legacyBehavior><small>Sign in to eHaho</small></Link> 
                        </div>
                            ...
                            {({
                                ...
                                <Form role="form" method="post">
                                    ...
                                    <div className="text-center">
                                        <Button className="my-4 w-100 bg-success text-white" onClick={()=>{sendEmail()}}>
                                           Next
                                        </Button>
                                    </div>
                                </Form>
